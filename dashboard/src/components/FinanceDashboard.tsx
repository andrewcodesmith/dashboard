...
const FinanceDashboard = ({ userData }: FinanceDashboardProps) => {
  const defaultData = {
    id: 'default',
  ...
  return (
    <div className="p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">{data.name}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-3xl font-bold text-blue-600">${data.netProfit.toLocaleString()}</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-3xl font-bold text-purple-600">${data.portfolioValue.toLocaleString()}</p>
